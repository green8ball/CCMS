...
namespace CCMS.Migrations
{
    ...
    [Migration("20190518060421_SchedulePattern")]
    partial class SchedulePattern
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CCMS.Models.SchedulePattern", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("SchedulePatterns");
                });

            modelBuilder.Entity("CCMS.Models.SchedulePatternRow", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<long?>("SchedulePatternId");
                    ...
                    b.HasIndex("SchedulePatternId");

                    b.ToTable("SchedulePatternRows");
                });
            ...
            modelBuilder.Entity("CCMS.Models.SchedulePatternRow", b =>
                {
                    b.HasOne("CCMS.Models.SchedulePattern")
                        .WithMany("Rows")
                        .HasForeignKey("SchedulePatternId");
                });
